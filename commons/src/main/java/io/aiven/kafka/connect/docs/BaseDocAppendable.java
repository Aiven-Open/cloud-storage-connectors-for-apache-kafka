 ...
 * <p>
 * This class is the superclass of all classes that filter help appendables. These appendable sit on top of an existing
 * appendable (the <em>underlying</em> appendable) which it uses as its basic sink of data, but possibly transforming
 * the data along the way or providing additional functionality.
 * </p>
 * <p>
 * The class {@code BaseDocAppendable} itself simply overrides all methods of {@code DocAppendable} with versions that
 * pass all requests to the underlying appendable. Subclasses of {@code BaseDocAppendable} may further override some of
 * these methods as well as provide additional methods and fields.
 * </p>
 * <p>
 * <em>Implementation Note</em>: This class is similar to FilterOutputStream in relation to OutputStream. We could
 * further split BaseDocAppendable into a FilterAppendable but that seems like YAGNI.
 * </p>
 *
 * @since 1.10.0
 */
