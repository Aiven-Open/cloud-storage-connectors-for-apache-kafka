 ...
 *
 * ConfigFragments require access to the parameter and string values from the configuration, but have different types of
 * data avialable to extract that data from. This interface defines the methods that the ConfigFragment may use to
...
public interface FragmentDataAccess {
     ...
     *
     * @param configValues
     *            the map of string to ConfigValues.
     * @return a FragmentDataAccess
     */
