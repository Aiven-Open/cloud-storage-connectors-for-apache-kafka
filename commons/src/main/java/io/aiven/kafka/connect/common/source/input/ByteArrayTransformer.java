 ...
 * <p>
 *     If the configuration option specifies a buffer that is smaller than the length of the input stream, the record
 *     will be split into multiple parts.  When this happens the transformer makes no guarantees for only once delivery
 *     or delivery order as those are dependant upon the Kafka producer and remote consumer configurations.  This class
 *     will produce the blocks in order and on restart will send any blocks that were not acknowledged by Kafka.
 * </p>
 */
