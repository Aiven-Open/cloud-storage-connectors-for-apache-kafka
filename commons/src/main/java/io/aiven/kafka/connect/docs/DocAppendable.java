...
/**
 * Defines a semantic scribe. The semantic scribe appends text to an output based on the semantic meaning of the type of
 * string. For example, a Paragraph versus a Heading.
 * <p>
 * The representation of the semantics is dependent upon the format being output. For example, the plain text output for
 * a paragraph may print the text followed by two line breaks, while an XHTML output would print the text surrounded by
 * &lt;p&gt; and &lt;/p&gt;.
 * </p>
 * <p>
 ...
 * @since 1.10.0
 */
public interface DocAppendable extends Appendable {
     ...
     *
     * @param format
     *            The format string for {@link String#format(String, Object...)}.
     * @param args
     ...
     *
     * @param level
     *            the level of the header. This is equivalent to the "1", "2", or "3" in the HTML "h1", "h2", "h3" tags.
     * @param text
     ...
     *
     * @param ordered
     *            {@code true} if the list should be ordered.
     * @param list
     *            the list to write.
     * @throws IOException
     *             If an output error occurs
