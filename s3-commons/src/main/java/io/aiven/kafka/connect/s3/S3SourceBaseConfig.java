...
public class S3SourceBaseConfig extends SourceCommonConfig {
    ...
    protected static void addS3RetryPolicies(final ConfigDef configDef) {
        ...
        configDef.define(AWS_S3_RETRY_BACKOFF_DELAY_MS_CONFIG, Type.LONG, AWS_S3_RETRY_BACKOFF_DELAY_MS_DEFAULT,
                ConfigDef.Range.atLeast(1L), Importance.MEDIUM,
        ...
        configDef.define(AWS_S3_RETRY_BACKOFF_MAX_DELAY_MS_CONFIG, Type.LONG, AWS_S3_RETRY_BACKOFF_MAX_DELAY_MS_DEFAULT,
                ConfigDef.Range.atLeast(1L), Importance.MEDIUM,
        ...
        configDef.define(AWS_S3_RETRY_BACKOFF_MAX_RETRIES_CONFIG, Type.INT, S3_RETRY_BACKOFF_MAX_RETRIES_DEFAULT,
                ConfigDef.Range.between(1L, 30), Importance.MEDIUM,
    ...
    protected static void addAwsConfigGroup(final ConfigDef configDef) {
        ...
        configDef.define(AWS_CREDENTIALS_PROVIDER_CONFIG, Type.CLASS, AWS_CREDENTIAL_PROVIDER_DEFAULT,
                Importance.MEDIUM,
    ...
    protected static void addAwsStsConfigGroup(final ConfigDef configDef) {
        ...
        configDef.define(AWS_STS_ROLE_ARN, Type.STRING, null, new ConfigDef.NonEmptyString(), Importance.MEDIUM,
                "AWS STS Role", GROUP_AWS_STS, awsStsGroupCounter++, // NOPMD
                                                                     // UnusedAssignment
                ConfigDef.Width.NONE, AWS_STS_ROLE_ARN);

        configDef.define(AWS_STS_ROLE_SESSION_NAME, Type.STRING, null, new ConfigDef.NonEmptyString(),
        ...
        configDef.define(AWS_STS_ROLE_SESSION_DURATION, Type.INT, 3600,
        ...
        configDef.define(AWS_STS_ROLE_EXTERNAL_ID, Type.STRING, null, new ConfigDef.NonEmptyString(), Importance.MEDIUM,
                "AWS STS External Id", GROUP_AWS_STS, awsStsGroupCounter++, // NOPMD UnusedAssignment
                ConfigDef.Width.NONE, AWS_STS_ROLE_EXTERNAL_ID);

        configDef.define(AWS_STS_CONFIG_ENDPOINT, Type.STRING, AwsStsEndpointConfig.AWS_STS_GLOBAL_ENDPOINT,
