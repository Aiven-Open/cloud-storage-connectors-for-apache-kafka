...
public final class GcsSinkConfig extends AivenCommonConfig {
    ...
    public static GcsSinkConfigDef configDef() {
    ...
    private static void addFileConfigGroup(final ConfigDef configDef) {
        ...
        }, ConfigDef.Importance.MEDIUM, "The prefix to be added to the name of each file put on GCS.", GROUP_FILE, 50,
                ConfigDef.Width.NONE, FILE_NAME_PREFIX_CONFIG);
