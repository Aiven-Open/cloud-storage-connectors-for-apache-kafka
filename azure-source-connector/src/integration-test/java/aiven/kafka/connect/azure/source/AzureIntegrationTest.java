...
public final class AzureIntegrationTest
        extends
            AbstractSourceIntegrationTest<String, BlobItem, AzureBlobOffsetManagerEntry, AzureBlobSourceRecord> {
    private static final Logger LOGGER = LoggerFactory.getLogger(AzureIntegrationTest.class);

    @Container
    static final AzuriteContainer AZURITE_CONTAINER = AzureStorage.createContainer();
    ...
    @BeforeEach
    void setupAWS() {
        sourceStorage = new AzureSourceStorage(AZURITE_CONTAINER);
    }
