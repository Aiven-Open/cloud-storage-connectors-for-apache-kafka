...
public class Version {
    ...
    private static final String PROPERTIES_FILENAME = "azure-blob-source-connector-for-apache-kafka-version.properties";

    public static final String VERSION; // NOPMD field name matches class name
