...
class FilenameTemplateValidatorTest {
    ...
    void validateVariableWithInvalidParameterName() {
        ...
        final String message =
                "Invalid value %s for configuration %s: unsupported set of template variables parameters, supported sets are: %s";
        assertThatThrownBy(() -> validator.ensureValid(null, value))
