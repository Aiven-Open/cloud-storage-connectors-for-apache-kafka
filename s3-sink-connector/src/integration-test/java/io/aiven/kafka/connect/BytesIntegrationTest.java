...
@Testcontainers
final class BytesIntegrationTest extends AbstractKafkaIntegrationBase {
    ...
    void groupByTimestampVariable(final CompressionType compression)
        ...
        final String[] expectedBlobs = expectedBlobsAndContent.keySet().toArray(new String[0]);
        Arrays.sort(expectedBlobs);
