...
@Testcontainers
public class S3SourceRecordIteratorIntegrationTest
        extends
            AbstractSourceIteratorIntegrationTest<String, S3Object, S3OffsetManagerEntry, S3SourceRecord, S3SourceRecordIterator> {
