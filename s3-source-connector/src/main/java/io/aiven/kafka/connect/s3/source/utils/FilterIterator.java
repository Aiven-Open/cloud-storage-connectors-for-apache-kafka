...
public class FilterIterator<E> implements Iterator<E> {
     ...
     * method can only be called if {@code next()} was called, but not after {@code hasNext()}, because the
     * {@code hasNext()} call changes the base iterator.
     *
     * @throws IllegalStateException
     *             if {@code hasNext()} has already been called.
     */
    @Override
    public void remove() {
        if (nextObjectSet) {
    ...
    /**
     * Sets nextObject to the next object. If there are no more objects, then return false. Otherwise, return true.
     */
