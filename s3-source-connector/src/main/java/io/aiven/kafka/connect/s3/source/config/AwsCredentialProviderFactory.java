...
public class AwsCredentialProviderFactory {
    public AWSCredentialsProvider getProvider(final S3SourceConfig config) {
    ...
    private AWSCredentialsProvider getStsProvider(final S3SourceConfig config) {
    ...
    private AWSSecurityTokenService securityTokenService(final S3SourceConfig config) {
