...
/**
 * Defines the transform from the S3 input stream Avro based data for the @{code byte[]} found in a
...
public class AvroTransformer implements Transformer {
    ...
    /**
     * Creates an fully configured KafkaAvroSerializer to create the output {@code byte[]}. Uses the
     * {@link S3SourceConfig#SCHEMA_REGISTRY_URL} and {@link S3SourceConfig#VALUE_SERIALIZER} values from the
     * configuration to configure the serializer.
     *
     * @param s3SourceConfig
     *            The S3 source configuration.
     * @return a fully configured KafkaAvroSerializer.
     * @throws NoSuchMethodException
     *             if the value serializer class does not define a no-argument constructor.
     * @throws InvocationTargetException
     *             if the value serializer class can not be instantiated.
     * @throws InstantiationException
     *             if the value serializer class can not be instantiated.
     * @throws IllegalAccessException
     *             if the value serializer class constructor can not be accessed.
     */
    static KafkaAvroSerializer createAvroSerializer(S3SourceConfig s3SourceConfig)
